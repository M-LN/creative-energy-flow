...
export default defineConfig({
        ...
        shortcuts: [
          {
            name: 'Log Energy',
            short_name: 'Log',
            description: 'Quick energy logging',
            url: '/log',
            icons: [
              {
                src: '/icon-96x96.png',
          ...
          },
          {
            name: 'View Charts',
            short_name: 'Charts',
            description: 'View energy visualizations',
            url: '/charts',
            icons: [
              {
                src: '/icon-96x96.png',
    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          charts: ['chart.js', '@chartjs/react-chartjs-2'],
  ...
  server: {
    https: false, // Enable for PWA testing in development
    host: true
  }
})